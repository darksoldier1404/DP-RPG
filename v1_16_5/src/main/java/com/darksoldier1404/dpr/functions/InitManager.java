...
import com.darksoldier1404.dpr.commands.admin.*;
import com.darksoldier1404.dpr.commands.user.DPRUserIllustrateCommand;
import com.darksoldier1404.dpr.commands.user.DPRUserStatsCommand;
...
public class InitManager {
    ...
    public static void init() {
        ...
        plugin.getCommand("dstats").setExecutor(new DPRUserStatsCommand());
        plugin.getCommand("dillustrate").setExecutor(new DPRUserIllustrateCommand());
    }
}
